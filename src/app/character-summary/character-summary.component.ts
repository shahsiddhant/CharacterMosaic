...
export class CharacterSummaryComponent implements OnInit {
  public characters: CharacterInfo[] = [
    ...
    },
    {
      name: 'Omar',
      description:
        'Omar represents the working class from the country side across all Central/Latin America.',
    ...
    //   name: "Thokmay",
    //   description:
    //     "Thokmay, pronounced TOK-meh, meaning unobstructed, unhindered, has been raised in the monastery as an orphan.",
    ...
    //   name: "Shola",
    //   description:
    //     "Young girl from Karonga, Malawi, who lost her arm to intruders at the age of six.",
    ...
    //   name: "Yannathan",
    //   description:
    //     "Yannathan, which means “walk about, travel or roam” is an 18 year old hunter from the 1830s.",
